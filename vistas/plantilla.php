                ...
                <div class="text-center">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="assets/img/quickie.png" alt="Profile" class="img-thumbnail">
                            <h2>Team Quickie</h2>
                            <h3>WebTeam Designer</h3>
                            <h3>----------------------------------------------------------------------------</h3>
                            <h3>Team Quickie, somos un equipo de desarollo formado en el <i>Segundo semestre del primer
                                    año de ISI</i>,
                                con la finalidad de derrotar a Armandol [Spoiler: Ganamos].
                            </h3>
                        </div>
                    </div>
